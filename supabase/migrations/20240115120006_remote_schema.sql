...
ALTER TABLE "public"."annonce_comments" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."annonce_comments_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."annonce_comments"
    ADD CONSTRAINT "annonce_comments_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
GRANT ALL ON SEQUENCE "public"."annonce_comments_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."annonce_comments_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."annonce_comments_id_seq" TO "service_role";
