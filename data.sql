...
INSERT INTO "storage"."buckets" ("id", "name", "owner", "created_at", "updated_at", "public", "avif_autodetection", "file_size_limit", "allowed_mime_types", "owner_id") VALUES
	('avatars', 'avatars', NULL, '2024-01-25 18:30:02.112186+00', '2024-01-25 18:30:02.112186+00', false, false, 10485760, '{image/*}', NULL);
...
with check ((auth.uid() = user_id))","CREATE POLICY \"Admin can assign role\" ON \"public\".\"user_roles\" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
  ...
  WHERE ((auth.uid() = user_roles.user_id) AND (user_roles.role = ''mod''::public.roles)))) AND (auth.uid() = user_id)))","create policy \"Enable delete for users based on user_id\"
on \"public\".\"annonces\"
as permissive
for delete
to public
using ((auth.uid() = user_id))","CREATE POLICY \"User can see its own role\" ON \"public\".\"user_roles\" FOR SELECT USING ((auth.uid() = user_id))","ALTER TABLE \"public\".\"annonce_comments\" ENABLE ROW LEVEL SECURITY","ALTER TABLE \"public\".\"annonce_likes\" ENABLE ROW LEVEL SECURITY","ALTER TABLE \"public\".\"annonces\" ENABLE ROW LEVEL SECURITY","ALTER TABLE \"public\".\"user_roles\" ENABLE ROW LEVEL SECURITY","GRANT USAGE ON SCHEMA \"public\" TO \"postgres\"","GRANT USAGE ON SCHEMA \"public\" TO \"anon\"","GRANT USAGE ON SCHEMA \"public\" TO \"authenticated\"","GRANT USAGE ON SCHEMA \"public\" TO \"service_role\"","GRANT ALL ON TABLE \"public\".\"user_profiles\" TO \"anon\"","GRANT ALL ON TABLE \"public\".\"user_profiles\" TO \"authenticated\"","GRANT ALL ON TABLE \"public\".\"user_profiles\" TO \"service_role\"","GRANT ALL ON TABLE \"public\".\"annonce_comments\" TO \"anon\"","GRANT ALL ON TABLE \"public\".\"annonce_comments\" TO \"authenticated\"","GRANT ALL ON TABLE \"public\".\"annonce_comments\" TO \"service_role\"","GRANT ALL ON TABLE \"public\".\"annonce_likes\" TO \"anon\"","GRANT ALL ON TABLE \"public\".\"annonce_likes\" TO \"authenticated\"","GRANT ALL ON TABLE \"public\".\"annonce_likes\" TO \"service_role\"","GRANT ALL ON TABLE \"public\".\"annonces\" TO \"anon\"","GRANT ALL ON TABLE \"public\".\"annonces\" TO \"authenticated\"","GRANT ALL ON TABLE \"public\".\"annonces\" TO \"service_role\"","GRANT ALL ON TABLE \"public\".\"user_roles\" TO \"anon\"","GRANT ALL ON TABLE \"public\".\"user_roles\" TO \"authenticated\"","GRANT ALL ON TABLE \"public\".\"user_roles\" TO \"service_role\"","ALTER DEFAULT PRIVILEGES FOR ROLE \"postgres\" IN SCHEMA \"public\" GRANT ALL ON SEQUENCES  TO \"postgres\"","ALTER DEFAULT PRIVILEGES FOR ROLE \"postgres\" IN SCHEMA \"public\" GRANT ALL ON SEQUENCES  TO \"anon\"","ALTER DEFAULT PRIVILEGES FOR ROLE \"postgres\" IN SCHEMA \"public\" GRANT ALL ON SEQUENCES  TO \"authenticated\"","ALTER DEFAULT PRIVILEGES FOR ROLE \"postgres\" IN SCHEMA \"public\" GRANT ALL ON SEQUENCES  TO \"service_role\"","ALTER DEFAULT PRIVILEGES FOR ROLE \"postgres\" IN SCHEMA \"public\" GRANT ALL ON FUNCTIONS  TO \"postgres\"","ALTER DEFAULT PRIVILEGES FOR ROLE \"postgres\" IN SCHEMA \"public\" GRANT ALL ON FUNCTIONS  TO \"anon\"","ALTER DEFAULT PRIVILEGES FOR ROLE \"postgres\" IN SCHEMA \"public\" GRANT ALL ON FUNCTIONS  TO \"authenticated\"","ALTER DEFAULT PRIVILEGES FOR ROLE \"postgres\" IN SCHEMA \"public\" GRANT ALL ON FUNCTIONS  TO \"service_role\"","ALTER DEFAULT PRIVILEGES FOR ROLE \"postgres\" IN SCHEMA \"public\" GRANT ALL ON TABLES  TO \"postgres\"","ALTER DEFAULT PRIVILEGES FOR ROLE \"postgres\" IN SCHEMA \"public\" GRANT ALL ON TABLES  TO \"anon\"","ALTER DEFAULT PRIVILEGES FOR ROLE \"postgres\" IN SCHEMA \"public\" GRANT ALL ON TABLES  TO \"authenticated\"","ALTER DEFAULT PRIVILEGES FOR ROLE \"postgres\" IN SCHEMA \"public\" GRANT ALL ON TABLES  TO \"service_role\"","-- inserts a row into public.user_profiles
...
create trigger on_auth_user_created
  ...
  for each row execute procedure public.handle_new_user()","RESET ALL"}', 'init'),
	('20240124170230', '{"alter table \"public\".\"user_profiles\" add column \"visible\" boolean default false","alter table \"public\".\"user_profiles\" add column \"name\" text","alter table \"public\".\"user_profiles\" add column \"short_desc\" text","alter table \"public\".\"user_profiles\" add column \"description\" text","alter table \"public\".\"user_profiles\" add column \"email\" text","alter table \"public\".\"user_profiles\" add column \"organisation\" text","alter table \"public\".\"user_profiles\" add column \"telephone\" text","alter table \"public\".\"user_profiles\" add column \"avatar_url\" text","INSERT INTO \"storage\".\"buckets\" (\"id\", \"name\", \"owner\", \"created_at\", \"updated_at\", \"public\", \"avif_autodetection\", \"file_size_limit\", \"allowed_mime_types\", \"owner_id\") VALUES
	(''avatars'', ''avatars'', NULL, ''2024-01-25 17:37:33.475659+00'', ''2024-01-25 17:37:33.475659+00'', true, false, 10485760, ''{image/*}'', NULL)","create policy \"Auth users can upload avatar\"
on \"storage\".\"objects\"
as permissive
for insert
to public
with check (((bucket_id = ''avatars''::text) AND (auth.role() = ''authenticated''::text)))","create policy \"Everyone can read avatar\"
on \"storage\".\"objects\"
as permissive
for select
to public
using ((bucket_id = ''avatars''::text))","create policy \"Enable read access for visible users\"
on \"public\".\"user_profiles\"
as permissive
for select
to public
using (visible = true)"}', 'user_profiles'),
	('20240125182320', '{}', 'annonces_delete');
